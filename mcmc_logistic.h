...
#ifndef mcmc_oo_mcmc_logistic_h
#define mcmc_oo_mcmc_logistic_h
...
/*
 Class: mcmc_baranyi: Specialised class for a logistic model. 
 */
class mcmc_logistic: public mcmc{
public:
    mcmc_logistic(std::vector<double> od, std::string l);
