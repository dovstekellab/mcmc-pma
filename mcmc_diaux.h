...
#ifndef mcmc_oo_mcmc_diaux_h
#define mcmc_oo_mcmc_diaux_h
...
/*
 Class: mcmc_diaux: Specialised class for diauxic substrate inhibition ODE model with curved lag phase.
 */ 
class mcmc_diaux: public mcmc{
public:
    mcmc_diaux(std::vector<double> od, std::string l);
