...
#ifndef mcmc_oo_mcmc_simplebaranyi2_h
#define mcmc_oo_mcmc_simplebaranyi2_h
...
/*
 Class: mcmc_simplebaranyi2: Specialised class for simplified Baranyi model. 
 */
class mcmc_simplebaranyi2: public mcmc{
public:
    mcmc_simplebaranyi2(std::vector<double> od, std::string l);
