...
#ifndef mcmc_oo_mcmc_baranyi_h
#define mcmc_oo_mcmc_baranyi_h
...
/*
 Class: mcmc_baranyi: Specialised class for Baranyi model. 
 */
class mcmc_baranyi: public mcmc{
public:
    mcmc_baranyi(std::vector<double> od, std::string l);
